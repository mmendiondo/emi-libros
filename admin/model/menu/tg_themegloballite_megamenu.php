...
class ModelMenuTGthemegloballiteMegamenu extends Model {
	...
	public function generate_nestable_list($lang_id) {
		...
		$action = $this->url->link('extension/module/tg_themegloballite_megamenu', 'token=' . $this->session->data['token'], 'SSL');
