...
class ControllerExtensionModuleTGtgliteFilterProduct extends Controller {
	...
	public function index() {   
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('extension/module/tg_tglite_filter_product', 'token=' . $this->session->data['token'], true));			
		}
		...
		$data['action'] = $this->url->link('extension/module/tg_tglite_filter_product', 'token=' . $this->session->data['token'], true);
